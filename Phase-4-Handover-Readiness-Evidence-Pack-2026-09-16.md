...
- **GAP-002** (secret custody) — **closed, 2026-09-21**: operator decided Render's own environment-variable storage is sufficient, no dedicated secrets-management provider needed. See `smp1-gap-002-secret-custody-decision-2026-09-21.md` (Standalone repo).
